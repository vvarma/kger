...
EntityModellerImpl::EntityModellerImpl(const std::shared_ptr<Vocabulary> &vocabulary, int label_count) :
        embedding_layer(register_module("embedding", torch::nn::Embedding(vocabulary->get_num_tokens(), 128))),
