...
struct Edge : has_unique_id {
    ...
    Edge(has_unique_id::uid id, std::string resource);
};
...
struct Node : has_unique_id {
    ...
    explicit Node(has_unique_id::uid);
...
struct EntityNode : Node {
    ...
    EntityNode(has_unique_id::uid, std::string);
...
struct NamedEntityNode : EntityNode, std::enable_shared_from_this<NamedEntityNode> {
    ...
    NamedEntityNode(has_unique_id::uid id, std::string resource, std::vector<has_unique_id::uid> parents,
                    std::string label);
...
struct InstanceNode : EntityNode, std::enable_shared_from_this<InstanceNode> {
    ...
    InstanceNode(has_unique_id::uid id, std::string resource, std::map<has_unique_id::uid, std::set<has_unique_id::uid>> relations);
...
struct LexicalNode : Node, std::enable_shared_from_this<LexicalNode> {
    ...
    LexicalNode(has_unique_id::uid id, std::vector<int> tokens);
